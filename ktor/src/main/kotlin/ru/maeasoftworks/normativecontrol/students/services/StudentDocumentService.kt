...
import ru.maeasoftworks.normativecontrol.shared.extensions.uploadSource
...
class StudentDocumentService(override val di: DI) : Service() {
    ...
    suspend fun uploadSource(documentId: String, uploadMultipart: UploadMultipart) = coroutineScope {
        launch { s3.uploadSource(documentId, uploadMultipart.file, uploadMultipart.accessKey) }
    }
}