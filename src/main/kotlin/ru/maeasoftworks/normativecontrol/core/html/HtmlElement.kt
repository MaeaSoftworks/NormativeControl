...
open class HtmlElement(
    ...
    inline fun div(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.div(body))
    }

    @HtmlDsl
    inline fun p(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.p(body))
    }

    @HtmlDsl
    inline fun span(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.span(body))
    }

    @HtmlDsl
    inline fun head(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.head(body))
    }

    @HtmlDsl
    inline fun body(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.body(body))
    }

    @HtmlDsl
    inline fun style(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.style(body))
    }

    @HtmlDsl
    inline fun script(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.script(body))
    }

    @HtmlDsl
    inline fun label(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.label(body))
    }

    @HtmlDsl
    inline fun input(body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.input(body))
    }

    @HtmlDsl
    inline fun create(type: String, hasClosingTag: Boolean = true, body: HtmlElement.() -> Unit) {
        addChild(ru.maeasoftworks.normativecontrol.core.html.create(type, hasClosingTag, body))
    }
