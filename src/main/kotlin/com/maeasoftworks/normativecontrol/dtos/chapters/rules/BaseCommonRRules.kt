...
object BaseCommonRRules {
    fun commonRFontCheck(documentId: String, rPr: RPr, p: Int, r: Int, isEmpty: Boolean, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun commonRFontSizeCheck(documentId: String, rPr: RPr, p: Int, r: Int, isEmpty: Boolean, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun commonRItalicCheck(documentId: String, rPr: RPr, p: Int, r: Int, isEmpty: Boolean, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun commonRStrikeCheck(documentId: String, rPr: RPr, p: Int, r: Int, isEmpty: Boolean, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun commonRHighlightCheck(documentId: String, rPr: RPr, p: Int, r: Int, isEmpty: Boolean, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun commonRColorCheck(documentId: String, rPr: RPr, p: Int, r: Int, isEmpty: Boolean, mainDocumentPart: MainDocumentPart): DocumentError? {
