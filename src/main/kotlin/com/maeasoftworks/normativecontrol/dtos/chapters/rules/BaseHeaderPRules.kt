...
object BaseHeaderPRules {
    fun headerPJustifyCheck(documentId: String, p: Int, isEmpty: Boolean, pPr: PPr, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun headerPLineSpacingCheck(documentId: String, p: Int, isEmpty: Boolean, pPr: PPr, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun headerPNotEndsWithDotCheck(documentId: String,
                                   p: Int,
                                   isEmpty: Boolean,
                                   pPr: PPr,
                                   mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun headerEmptyLineAfterHeaderExist(documentId: String,
                                        p: Int,
                                        isEmpty: Boolean,
                                        pPr: PPr,
                                        mainDocumentPart: MainDocumentPart): DocumentError? {
