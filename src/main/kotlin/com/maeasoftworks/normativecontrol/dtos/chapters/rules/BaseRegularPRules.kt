...
object BaseRegularPRules {
    fun regularPJustifyCheck(documentId: String, p: Int, isEmpty: Boolean, pPr: PPr, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun regularPLineSpacingCheck(documentId: String, p: Int, isEmpty: Boolean, pPr: PPr, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun regularPFirstLineIndentCheck(documentId: String, p: Int, isEmpty: Boolean, pPr: PPr, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun regularPLeftIndentCheck(documentId: String, p: Int, isEmpty: Boolean, pPr: PPr, mainDocumentPart: MainDocumentPart): DocumentError? {
    ...
    fun regularPRightIndentCheck(documentId: String, p: Int, isEmpty: Boolean, pPr: PPr, mainDocumentPart: MainDocumentPart): DocumentError? {
