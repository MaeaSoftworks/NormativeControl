            ...
            object P {
                fun notBordered(
                    ...
                    return if (pPr.pBdr != null) {
                        DocumentError(documentId, p, -1, if (isEmpty) ErrorType.TEXT_WHITESPACE_BORDER else ErrorType.TEXT_COMMON_BORDER)
                    } else null
                }
        ...
        object Header {
            ...
            object R {
                fun isUppercase(
                    ...
                    val text = TextUtils.getText((mainDocumentPart.content[p] as org.docx4j.wml.P).content[r] as org.docx4j.wml.R)
