...
class ResolverWrapper(private val resolver: PropertyResolver) {
    ...
    fun getEffectiveRPr(r: R): RPr {
        return rPrs[r] ?: resolver.getEffectiveRPr(r.rPr, pPrs[(r.parent as P).paraId] ?: getEffectivePPr(r.parent as P))
    }
}